export const FAKE_USER = {
  ...
  lastName: 'Ceddia',
  username: 'dave',
  avatar: 'https://www.gravatar.com/avatar/5c3dd2d257ff0e14dbd2583485dd44b?s=32'
};
...
export function login(username, password) {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      if (username === 'youssef' && password === 'password') {
        resolve(FAKE_USER);
      } else {
        reject({ message: 'Test with youssef/password' });
      }
    }, 300);
  });
}
